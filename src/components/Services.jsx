...
export default function Services() {
  return (
    <section id="services" className="bg-gray-950 py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {services.map(s => (
            <div
              key={s.num}
              className={`card-glow group bg-gray-900/40 border border-gray-800 rounded-2xl p-8 transition-all duration-300 ${s.border}`}
            >
              ...
              <div className="w-10 h-px bg-gray-800 mb-5 group-hover:bg-amber-500/60 transition-colors duration-300" />
