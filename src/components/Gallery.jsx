...
export default function Gallery() {
  ...
  return (
    <>
      <section id="gallery" className="bg-gray-900 py-24 px-4">
      ...
      {selected !== null && (
        ...
        >
          ...
          <button
            ...
            className="absolute left-4 sm:left-8 z-10 text-white/60 hover:text-amber-400 p-3 transition-colors duration-200 rounded-full hover:bg-white/10"
            aria-label="Previous"
          >
          ...
          <button
            ...
            className="absolute right-4 sm:right-8 z-10 text-white/60 hover:text-amber-400 p-3 transition-colors duration-200 rounded-full hover:bg-white/10"
            aria-label="Next"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
          ...
          <button
            onClick={() => setSelected(null)}
            className="absolute top-4 right-4 z-10 text-white/60 hover:text-amber-400 p-2 transition-colors duration-200 rounded-full hover:bg-white/10"
            aria-label="Close"
          >
          ...
          <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1">
            <p className="text-white/50 text-xs tracking-wider">{images[selected].alt}</p>
            <p className="text-white/30 text-xs tracking-widest">{selected + 1} / {images.length}</p>
          </div>
        </div>
      )}
    </>
